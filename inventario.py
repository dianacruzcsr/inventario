...
def procesar_datos(df):
    ...
    try:
        ...
        # Calcular área - CORRECCIÓN IMPORTANTE
        ...
        st.success(f"Procesamiento completado. Registros: {len(df_procesado)}, "
                  f"Con área calculada: {df_procesado['AREA'].notna().sum()}")
